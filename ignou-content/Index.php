...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            <span class="d-block d-lg-none">MSCPH</span>
    ...
    <div class="container-fluid p-0">
        ...
        <section class="resume-section" id="books">
            <div class="resume-section-content">
                <h2 class="mb-5">MSCPH e-Books</h2>
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php 
                            $i = 1;
                            foreach($contents as $s => $subject) {
                                foreach($subject as $p => $paper) {
                                    foreach($paper as $b => $block){
                            ?>
                                <tr>
                                    <td><?= $i ?> </td>
                                    <td><?= $s ?></td>
                                    <td><?= $p?></td>
                                    <td><?= $b ?></td>
                                    <td><a href="<?= $block ?>" target="_blank">View</a></td>
